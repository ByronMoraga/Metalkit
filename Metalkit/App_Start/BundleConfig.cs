    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/animate.css",
                      "~/Content/style.css",
                       "~/Content/StylesAdquisiciones.css"
                      ));
            ...
            bundles.Add(new StyleBundle("~/Content/plugins/dataTables/dataTablesStyles").Include(
                      ...
                      "~/Scripts/plugins/dataTables/Buttons/css/buttons.dataTables.css"));

            // dataTables 
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                      "~/Scripts/plugins/dataTables/datatables.min.js",
                      "~/Scripts/plugins/dataTables/Buttons/js/dataTables.buttons.js",
                      "~/Scripts/plugins/dataTables/Buttons/js/buttons.print.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/modal").Include(
                "~/Scripts/jquery-3.2.1.js",
                 "~/Scripts/funcionesModal.js",
                 "~/Scripts/mensajeria.js"
                 ));

            bundles.Add(new ScriptBundle("~/bundles/validaciones").Include(
                "~/Scripts/jquery.validate.js",
                 "~/Scripts/validacionesFormularios.js"
                 //,"~/Scripts/jquery.validate.unobtrusive.js"
                 ));

            bundles.Add(new ScriptBundle("~/bundles/maskmoney").Include(
                "~/Scripts/plugins/jquery-maskmoney/jquery.maskMoney.js",
                "~/Scripts/plugins/jquery-maskmoney/funcionesMaskMoney.js"
            ));
